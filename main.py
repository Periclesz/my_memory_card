...
questions_list = []
questions_list.append(Question('The national language of Brazil','Portugese','Brazillian','Spanish','Italian'))
questions_list.append(Question('Who was the first president of Macedonia?','Boris Trajkovski','Kiro Gligorov','Gjorgi Ivanov','Stevo Pendarovski'))
questions_list.append(Question('The national language of China?','Chinese','Han Chinese','Asian','Japanese'))
